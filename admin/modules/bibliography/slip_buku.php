...
if (isset($_GET['action']) AND $_GET['action'] == 'print') {
	...
	$html_str .= '<head>'."\n";
	$html_str .= '<title>Hasil Cetak Slip Buku by Muh Tarom</title>'."\n";
	...
	if ($file_write) {
		...
		echo '<script type="text/javascript">top.$.colorbox({href: "'.SWB.FLS.'/'.$print_file_name.'", iframe: true, width: 800, height: 500, title: "Hasil Cetak Kartu Buku : Muh Tarom & M.Zaemakhrus"})</script>';
