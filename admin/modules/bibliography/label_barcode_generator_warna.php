...
<div class="menuBoxInner printIcon">
  ...
  <div class="sub_section">
      ...
      <a target="blindSubmit" href="<?php echo MWB; ?>bibliography/label_barcode_generator_warna.php?action=print" class="notAJAX btn btn-default"><i class="glyphicon glyphicon-print"></i>&nbsp;<?php echo __('Print Barcodes for Selected Data');?></a>
