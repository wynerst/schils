...
$freeloancard_include_address_label = 0; // alamat

// Freeloancard Settings , Ubah variabel berikut , 
  // File gambar diletakkan dalam folder ...htdocs\slims7_cendana\files */
  // Gunakan Kertas Ukuran A4 */

$freeloancard_box_width = 29; //lebar kartu bebas pustaka
$freeloancard_box_height = 19; //tinggi kartu bebas pustaka 
$freeloancard_logo = "logo1.png"; //nama file logo , pastikan nama file sama perhatikan besar kecil nya huruf
$freeloancard_front_header1_text = "</br> Perpustakaan Ketik Nama Perpustakaan </br>Di Sini "; // Nama Perpustakaan gunakan tag <br /> untuk pindah baris
$freeloancard_front_header1_font_size = "22"; //Ukuran font pada kepala kartu bebas pustaka yaitu pada Nama Perpustakaan
$freeloancard_front_header2_text = "Alamat Nomor Telepon Alamat Email dan Sebagai nya Ketik Disini</br> "; // Alamat dan nomor telepon perpustakaan
$freeloancard_front_header2_font_size = "18"; //Ukuran font pada tulisan alamat dan nomor telepon perpustakaan
$freeloancard_front_header3_text = "</br>SURAT KETERANGAN BEBAS PUSTAKA<br /> <b>Nomor: __.___/p/__/2014</b>"; // gunakan tag <br /> untuk pindah baris
$freeloancard_front_header3_font_size = "20"; //Ukuran Font pada judul surat
$freeloancard_header_color = "#01005F"; //Warna Header gunakan kode warna HTML misal nya. :#0066FF, green, etc.
$freeloancard_front_body1_text = "Yang bertanda tangan di bawah ini menerangkan bahwa:"; // gunakan tag <br /> untuk pindah baris
$freeloancard_front_body1_font_size = "18"; //Ukuran Font pada isi surat
$freeloancard_front_body2_text = "Mahasiswa tersebut di atas tidak mempunyai pinjaman pustaka milik Perpustakaan XYZ.<br />Surat Keterangan ini untuk: Wisuda, Pengambilan Ijazah, Pengambilan Transkip Nilai."; // gunakan tag <br /> untuk pindah baris
...
$freeloancard_lokasi_stempel = "Jepara,......................"; //Kota 
$freeloancard_jabatan_stempel = "Kepala Perpustakaan";
$freeloancard_pejabat_stempel = "</br></br>Drs. Desawarna M.Si"; //Nama Kepala Perpustakaan
$freeloancard_nip_pejabat_stempel = "08091988"; //NIP
$freeloancard_gambar_ttd_stempel = "ttd.png"; // Gambar Tanda Tangan


// Book Card print settings /Kartu Buku
...
/* measurement in cm */
    /* gunakan kertas ukuran kertas A4 */
...
$bookcard_address_text = 'Alamat Telpon Perpustakaan Ketik Disini '; // tuliskan alamat perpustakaan di sini 
...
$bookslip_items_per_row = 2; //jumlah kartu buku perbaris
$bookslip_width = 9; //lebar kartu buku dalam satuan CM
...
$bookslip_address_text = 'Alamat Telpon Perpustakaan Ketik Disini'; // tuliskan alamat perpustakaan dalam tanda petik 
